...
const emailBody = data => `
  <html><body>
    <h1>Новое сообщение с сайта Web.levelupworlds.com</h1>
    <p>С сайта Web.levelupworlds.com поступил новый заказ от клиента. Обработайте данный заказ как можно скорее</p>
    <ul>
